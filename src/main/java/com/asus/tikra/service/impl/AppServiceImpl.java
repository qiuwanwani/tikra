...
import com.asus.tikra.constant.AppConstant;
import com.asus.tikra.core.AiCodeGeneratorFacade;
...
import com.asus.tikra.mapper.AppMapper;
...
import com.asus.tikra.model.enums.ChatHistoryMessageTypeEnum;
...
import com.asus.tikra.service.AppService;
import com.asus.tikra.service.ChatHistoryService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        if (!app.getUserId().equals(loginUser.getId())) {
            throw new BusinessException(ErrorCode.NOT_AUTH_ERROR, "无权限访问该应用");
        }
